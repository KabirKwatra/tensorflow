...
class _AutoShardDataset(dataset_ops.UnaryDataset):
    ...
    def __init__(self, input_dataset, num_workers, index):
        ...
        if compat.forward_compatible(2019, 11, 25) or (input_dataset.options(
        ).experimental_distribute.auto_shard_policy != AutoShardPolicy.AUTO):
...
def replicate(dataset, devices):
    ...
    with ops.colocate_with(dataset._variant_tensor):
        ...
        graph_def = dataset._as_serialized_graph(strip_device_assignment=True,
