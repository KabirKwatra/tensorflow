...
class TTParameters(object):
    ...
    def _validate_flag_names(self):
        ...
        valid_flag_names = [
            ...
            FLAG_NAME_USE_COMPACT_TRACE,
            FLAG_NAME_TRACE_SCALAR_OPS,
            FLAG_NAME_TRACE_BEFORE_OPS,
            FLAG_NAME_TRACE_AFTER_OPS,
            FLAG_NAME_TRACE_STACK_SIZE,
            FLAG_NAME_SUBMODE,
            FLAG_NAME_EXCLUDED_OPNAMES,
            FLAG_NAME_EXCLUDED_OPTYPES,
            FLAG_NAME_INCLUDED_OPNAMES,
    ...
    def get_signature_to_agg_fn_map(self):
        ...
        return {
            ...
            # Simply reduce max variance.
            TT_SUMMARY_VAR: math_ops.reduce_max,
