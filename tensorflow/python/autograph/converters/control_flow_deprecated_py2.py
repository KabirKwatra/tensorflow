...
class ControlFlowTransformer(converter.Base):
    ...
    def visit_If(self, node):
        ...
        possibly_undefined = set(basic_created_in_body) ^ set(
            basic_created_in_orelse)
    ...
    def _get_composite_loop_vars(self, modified_symbols, live_in):
        ...
        for s in modified_symbols:
            ...
            support_set_symbols = tuple(sss for sss in s.support_set
                                        if sss.is_symbol())
    ...
    def _get_loop_vars(self, node, modified_symbols):
        ...
        basic_loop_vars = self._get_basic_loop_vars(modified_symbols, live_in,
                                                    live_out)
