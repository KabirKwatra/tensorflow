...
class ActivityAnalyzerTest(ActivityAnalyzerTestBase):
    ...
    def test_import(self):
        ...
        def test_fn():
            ...
            import b.x
            import y as c
            import z.u as d  # pylint:disable=g-multiple-import,g-import-not-at-top,unused-variable
    ...
    def test_while(self):
        ...
        self.assertScopeIs(
            anno.getanno(
                while_node, NodeAnno.BODY_SCOPE).parent, ('a', 'b', 'c'),
            ('b', 'c'))
        self.assertScopeIs(
    ...
    def test_for(self):
        ...
        self.assertScopeIs(
            anno.getanno(
                for_node, NodeAnno.BODY_SCOPE).parent, ('a', 'b', 'c'),
            ('b', 'c', '_'))
    ...
    def test_if(self):
        ...
        self.assertScopeIs(
            anno.getanno(
                if_node, NodeAnno.BODY_SCOPE).parent, ('x', 'y', 'z', 'u'),
            ('x', 'y', 'z', 'u'))
        self.assertScopeIs(
    ...
    def test_if_attributes(self):
        ...
        self.assertScopeIs(
            anno.getanno(
                if_node, NodeAnno.BODY_SCOPE).parent, ('a', 'a.c', 'd'),
            ('a.b', 'd'))
    ...
    def test_if_subscripts(self):
        ...
        if_node = node.body[0]
        self.assertScopeIs(
            anno.getanno(if_node, NodeAnno.BODY_SCOPE), ('a',
                                                         'b', 'c', 'a[c]'),
            ('a[b]', 'd'))
    ...
    def test_constructor_attributes(self):
        ...
        self.assertScopeIs(
            anno.getanno(init_node, NodeAnno.BODY_SCOPE), ('self',
                                                           'a', 'self.b'),
    ...
    def test_return_vars_are_read(self):
        ...
        node, _ = self._parse_and_analyze(test_fn)
        fn_node = node
        self.assertScopeIs(anno.getanno(
            fn_node, NodeAnno.BODY_SCOPE), ('c',), ())
        self.assertScopeIs(
    ...
    def test_params(self):
        ...
        self.assertSymbolSetsAre(
            ('a', 'b'), args_scope.params.keys(), 'params')
    ...
    def test_lambda_nested(self):
        ...
        def test_fn(a, b, c, d, e):  # pylint: disable=unused-argument
            def a(a, b): return d(lambda b: a + b +
                                  c)  # pylint: disable=undefined-variable
    ...
    def test_comprehension_generator_order(self):
        ...
        def test_fn(a, b, c):  # pylint:disable=unused-argument
            e = {d: (a, b) for (
                a, b) in c for d in b}  # pylint:disable=unused-variable,g-complex-comprehension
