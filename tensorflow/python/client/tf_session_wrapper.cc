...
PYBIND11_MODULE(_pywrap_tf_session, m) {
    ...
    [](const TF_DeviceList* list) {
        return TF_DeviceListCount(list);
    });
    ...
    m.def("get_git_version", []() {
        return tf_git_version();
    });
    m.def("get_compiler_version", []() {
        return tf_compiler_version();
    });
    m.def("get_cxx11_abi_flag", []() {
        return tf_cxx11_abi_flag();
    });
    m.def("get_monolithic_build", []() {
        return tf_monolithic_build();
    });
    m.def("get_graph_def_version", []() {
        return TF_GRAPH_DEF_VERSION;
    });
