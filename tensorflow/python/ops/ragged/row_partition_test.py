...
class RowPartitionSpecTest(test_util.TensorFlowTestCase,
    ...
    @parameterized.parameters([
        ...
        (0, None, None, dtypes.int32, 0, 0, None,
         dtypes.int32),  # nvals inferred
        (None, None, 0, dtypes.int32, None, 0, 0,
         dtypes.int32),  # nvals inferred
    ])  # pyformat: disable
    ...
    def testFromValue(self):
        self.assertEqual(
            RowPartitionSpec.from_value(
                RowPartition.from_row_splits([0, 2, 8, 8])),
        ...
        self.assertEqual(
            RowPartitionSpec.from_value(
                RowPartition.from_uniform_row_length(nvals=12,
                                                     uniform_row_length=3)),
...
def _assert_row_partition_equal(test_class, actual, expected):
    ...
    if expected.has_precomputed_value_rowids():
        test_class.assertAllEqual(actual.value_rowids(),
                                  expected.value_rowids())
