...
class RaggedBatchGatherOpTest(test_util.TensorFlowTestCase,
    ...
    @parameterized.parameters([
        ...
        dict(
            ...
            params=ragged_factory_ops.constant_value([["a", "b", "c"], ["d"],
                                                      [], ["e"]]),
            indices=ragged_factory_ops.constant_value([[1, 2, 0], [], [],
                                                       [0, 0]]),
    ...
    @parameterized.parameters([
        ...
        dict(
            ...
            indices=[[[8, 8823], [0, 100]], [[3, 23, 35, 45, 75, 83, 1234],
                                             [5]]],
            expected=[
                [["!", "$NONE^"], ["Foo", "$NONE^"]],
                [[".", ".", ".", ".", "!", ".", "$NONE^"], ["bamboozled"]],
    ...
    def testRaggedBatchGatherWithDefault(
        ...
        indices = ragged_factory_ops.constant(indices,
                                              ...
                                              or ragged_rank)
        expected = ragged_factory_ops.constant(expected,
    ...
    def testRaggedBatchGatherWithDefaultOnTensors(self, descr, params, indices,
