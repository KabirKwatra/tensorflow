...
from tensorflow.python.ops import (array_ops, clip_ops, data_flow_ops,
                                   math_ops, resource_variable_ops, sparse_ops,
                                   variables)
    ...
    with ops.name_scope(name, "embedding_lookup", params + [ids]) as name:
        ...
        if np == 1 and (not transform_fn or ids.get_shape().ndims == 1):
            ...
            if partition_strategy == "mod":
                ...
                raise ValueError(
                    "Unrecognized partition strategy: " + partition_strategy
                )
