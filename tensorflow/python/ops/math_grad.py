...
def _DivGrad(op, grad):
    ...
    y = math_ops.conj(y)
    return (
        array_ops.reshape(math_ops.reduce_sum(math_ops.divide(grad, y), rx),
                          sx),
        array_ops.reshape(
            math_ops.reduce_sum(
...
def _RealDivGrad(op, grad):
    ...
    y = math_ops.conj(y)
    return (
        array_ops.reshape(math_ops.reduce_sum(math_ops.realdiv(grad, y), rx),
                          sx),
        array_ops.reshape(
            math_ops.reduce_sum(
...
def _DivNoNanGrad(op, grad):
    ...
    return (
        ...
        array_ops.reshape(
            math_ops.reduce_sum(
                grad * math_ops.div_no_nan(math_ops.div_no_nan(-x, y), y), ry),
            sy,
        ),
    )
