...
class GCEClusterResolverTest(test.TestCase):
    ...
    def standard_mock_instance_groups(self, instance_map=None):
        if instance_map is None:
            instance_map = [{
                "instance":
                "https://gce.example.com/res/gce-instance-1"
            }]
    ...
    def standard_mock_service_client(self,
    ...
    def gen_standard_mock_service_client(self, instances=None):
        ...
        for instance in instances:
            ...
            instance_list.append({
                "instance":
                "https://gce.example.com/gce/res/" + instance["name"]
            })
        ...
        return self.standard_mock_service_client(mock_instance_group,
                                                 mock_instance)
    ...
    def testMasterRetrievalWithCustomTasks(self):
        ...
        self.assertEqual(gce_cluster_resolver.master("worker", 2, "test"),
                         "test://10.3.4.5:8470")
    ...
    def testOverrideParametersWithZeroOrEmpty(self):
        ...
        self.assertEqual(gce_cluster_resolver.master(task_type="", task_id=0),
                         "grpc://10.1.2.3:8470")
