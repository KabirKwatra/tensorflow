...
class AutomaticControlDependenciesTest(test.TestCase):
    ...
    def _testVariableReadInFunctionalOp(self, build_functional_op, op_type):
        ...
        def read_var_in_while():
            gen_resource_variable_ops.read_variable_op(v.handle,
                                                       v.dtype,
                                                       name="read1")
    ...
    def testVariableReadInWhileLoop(self):
        def build_functional_op(v):
            ...
            return control_flow_ops.while_loop(lambda i: True,
                                               body, [0.0],
    ...
    def testVariableReadInCondFalseBranch(self):
        def build_functional_op(v):
            ...
            return control_flow_ops.cond(constant_op.constant(False),
                                         then_branch, else_branch)
    ...
    def testRepeatedResourceInput(self):
        ...
        def inner(var1, var2):
            return resource_variable_ops.read_variable_op(
                var1, dtypes.float32) + resource_variable_ops.read_variable_op(
                    var2, dtypes.float32)
