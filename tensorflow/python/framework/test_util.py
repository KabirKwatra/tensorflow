...
from tensorflow.python import (_pywrap_stacktrace_handler, _pywrap_util_port,
                               tf2)
from tensorflow.python.client import device_lib, pywrap_tf_session, session
from tensorflow.python.compat.compat import forward_compatibility_horizon
from tensorflow.python.eager import context, def_function, tape
from tensorflow.python.framework import device as pydev
from tensorflow.python.framework import (dtypes, errors, errors_impl, gpu_util,
                                         importer, ops, random_seed,
                                         sparse_tensor, tensor_shape,
                                         tensor_util, versions)
from tensorflow.python.ops import (array_ops, control_flow_util,
                                   control_flow_util_v2, script_ops,
...
from tensorflow.python.util import (compat, deprecation, nest, tf_decorator,
                                    tf_inspect)
        ...
        for attr_key in node.attr:
            ...
            if attr_tensor_value and len(attr_tensor_value.string_val) == 1:
                ...
                if attr_tensor_string_value and re.match(
                    _SHARDED_SAVE_OP_PATTERN, str(attr_tensor_string_value)
                ):
...
def run_in_graph_and_eager_modes(
    func=None, config=None, use_gpu=True, reset_test=True, assert_no_eager_garbage=False
):
...
class TensorFlowTestCase(googletest.TestCase):
    ...
    @contextlib.contextmanager
    def cached_session(self, graph=None, config=None, use_gpu=False, force_gpu=False):
