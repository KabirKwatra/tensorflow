...
@parameterized.named_parameters(
    ...
    dict(testcase_name="list_of_built_in_fn_and_list",
    ...
    dict(testcase_name="list_of_custom_fn_and_list",
         value=[_my_mae, [_my_mae]]),
    dict(
        testcase_name="list_of_custom_class_and_list",
        value=[MyMeanAbsoluteError, [MyMeanAbsoluteError]],
    ),
    dict(testcase_name="list_of_lists_of_custom_fns",
