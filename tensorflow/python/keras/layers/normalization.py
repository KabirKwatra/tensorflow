...
class BatchNormalizationBase(Layer):
    ...
    def _fused_batch_norm(self, inputs, training):
        ...
        if use_fused_avg_updates and input_batch_size is not None:
            ...
            def train_op(): return tf_utils.smart_cond(input_batch_size > 0,
    ...
    def _moments(self, inputs, reduction_axes, keep_dims):
        ...
        if self._support_zero_size_input():
            input_batch_size = array_ops.shape(inputs)[0]
            mean = array_ops.where(input_batch_size > 0,
                                   mean, K.zeros_like(mean))
    ...
    def call(self, inputs, training=None):
        ...
        if training_value == False:  # pylint: disable=singleton-comparison,g-explicit-bool-comparison
            ...
            if self.virtual_batch_size is not None:
                ...
                new_variance = math_ops.reduce_mean(
