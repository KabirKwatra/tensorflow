    ...
    * `result()`: Computes and returns a value for the metric
    ...
    def __new__(cls, *args, **kwargs):
        ...
        if (base_layer_utils.is_in_eager_or_tf_function()
                or cls.__module__ == Metric.__module__):
...
class SensitivityAtSpecificity(SensitivitySpecificityBase):
    ...
    def result(self):
        ...
        # given specificity.
        min_index = math_ops.argmin(math_ops.abs(specificities - self.value),
                                    axis=0)
...
class SpecificityAtSensitivity(SensitivitySpecificityBase):
    ...
    def result(self):
        ...
        # requested value.
        min_index = math_ops.argmin(math_ops.abs(sensitivities - self.value),
                                    axis=0)
        min_index = math_ops.cast(min_index, dtypes.int32)
...
class PrecisionAtRecall(SensitivitySpecificityBase):
    ...
    def result(self):
        ...
        # requested value.
        min_index = math_ops.argmin(math_ops.abs(recalls - self.value), axis=0)
        min_index = math_ops.cast(min_index, dtypes.int32)
...
class RecallAtPrecision(SensitivitySpecificityBase):
    ...
    def result(self):
        ...
        feasible = array_ops.where(
            math_ops.greater_equal(precisions, self.value))
