...
def create_central_storage_strategy():
    ...
    compute_devices = ['cpu:0', 'gpu:0'] if context.num_gpus() >= 1 else [
        'cpu:0']
...
class KerasModelTest(keras_parameterized.TestCase):
    ...
    def test_restore_old_loss_scale_checkpoint(self):
        ...
        expected_slot = np.array(
            [[10.049943, 9.917691], [10.049943, 9.917691]])
        ...
        self.assertNotAllClose(self.evaluate(
            model.weights[0]), expected_kernel)
