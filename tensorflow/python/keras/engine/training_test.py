...
class TrainingTest(keras_parameterized.TestCase):
    ...
    def test_losses_of_different_dtypes(self):
        ...
        out_1 = layers_module.Dense(2,
                                    dtype="float32",
                                    kernel_regularizer="l2")(inp)
        out_2 = layers_module.Dense(2,
                                    dtype="float16",
                                    kernel_regularizer="l2")(inp)
...
class TestTrainingWithDataTensors(keras_parameterized.TestCase):
    ...
    def test_model_with_input_feed_tensor(self):
        ...
        with ops.Graph().as_default(), self.cached_session():
            ...
            input_v = backend.variables_module.Variable(input_a_np,
                                                        dtype="float32")
    ...
    def test_model_custom_target_tensors(self):
        with ops.Graph().as_default(), self.cached_session():
            ...
            pl_target_a = backend.array_ops.placeholder("float32",
                                                        shape=(None, 4))
            model.compile(optimizer="rmsprop",
                          loss="mse",
