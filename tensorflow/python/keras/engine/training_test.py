...
class TrainingTest(keras_parameterized.TestCase):
    ...
    def test_weight_shared_across_layers(self):
        ...
        class LayerWithWeightSharedLayers(keras.layers.Layer):
            def __init__(self):
                ...
                shared_trainable_var = resource_variable_ops.ResourceVariable(1.0)
    ...
    def test_mismatched_output_shape_and_target_shape(self):
        model = keras.Sequential(
            [keras.layers.Dense(2, input_shape=(3, 4)), keras.layers.Dense(5),]
        )
        model.compile(
    ...
    def test_regularizer_of_different_dtype(self):
        ...
        out = keras.layers.Dense(2, dtype="float32", kernel_regularizer=regularizer)(
            inp
        )
        ...
        with self.cached_session():
            ...
            model.add(
                keras.layers.TimeDistributed(
                    keras.layers.Dense(num_classes), input_shape=(timesteps, input_dim)
                )
            )
...
class TestTrainingWithDataTensors(keras_parameterized.TestCase):
    ...
    def test_model_custom_target_tensors(self):
        with ops.Graph().as_default(), self.cached_session():
            ...
            pl_target_a = keras.backend.array_ops.placeholder(
    ...
    def test_metrics_valid_compile_input_formats(self):
        ...
        model.compile(
            ...
            metrics=[
                ...
                [keras.metrics.MeanSquaredError(), keras.metrics.Accuracy()],
            ],
            weighted_metrics=[
                keras.metrics.MeanSquaredError(),
                [keras.metrics.MeanSquaredError(), keras.metrics.Accuracy()],
        ...
        model.compile(
            ...
            loss="mse",
            metrics={
                "output_1": keras.metrics.MeanSquaredError(),
                "output_2": [
                    keras.metrics.MeanSquaredError(),
