...
class Network(base_layer.Layer):
    ...
    def _init_graph_network(self, inputs, outputs, name=None, **kwargs):
        ...
        self._nested_inputs_are_flat_list = isinstance(
            self._nested_inputs, (list, tuple)) and not any(
                nest.is_sequence(t) for t in self._nested_inputs)
            ...
            for node in nodes:
                ...
                if all(
                    ...
                    if "training" in argspec:
                        ...
                        if type(kwargs["training"]) is ops.Tensor and any(  # pylint: disable=unidiomatic-typecheck
                            [
    ...
    def _flatten_to_reference_inputs(self, tensors):
        ...
        if self._nested_inputs_are_flat_list and isinstance(tensors, dict):
            ...
            tensors = [
                ...
                for inp in self._nested_inputs
            ]
        else:
