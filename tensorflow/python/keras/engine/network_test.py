...
class NetworkConstructionTest(keras_parameterized.TestCase):
    ...
    def test_multi_input_layer(self):
        with self.cached_session():
            ...
            model = training_lib.Model(inputs=[a, b],
                                       outputs=[c, d],
                                       name="model")
            ...
            fn = backend.function(recreated_model.inputs,
    ...
    def test_multi_input_multi_output_recursion(self):
        with self.cached_session():
            ...
            fn = backend.function(multi_io_model.inputs,
    ...
    def test_model_initialization(self):
        ...
        # Subclassed model
        model = training_lib.Model(name="subclassed",
                                   trainable=True,
                                   dtype="int64",
                                   dynamic=True)
    ...
    def test_disconnected_inputs(self):
        ...
        net = network_lib.Network(inputs=[input_tensor1, input_tensor2],
...
class NestedNetworkTest(keras_parameterized.TestCase):
    ...
    def test_nested_network_inside_network(self):
        ...
        inner_outputs = {
            ...
            "x1*x2":
            layers.Multiply()([inner_inputs["x1"], inner_inputs["x2"]]),
        }
