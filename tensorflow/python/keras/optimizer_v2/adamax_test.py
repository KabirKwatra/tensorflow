    ...
    def testResourceSparse(self):
        ...
        for dtype in [dtypes.half, dtypes.float32, dtypes.float64]:
            with ops.Graph().as_default(), self.cached_session(use_gpu=True):
                ...
                def zero_slots(): return np.zeros(
                    (3), dtype=dtype.as_numpy_dtype)  # pylint: disable=cell-var-from-loop
    ...
    def testSparseDevicePlacement(self):
        ...
        for index_dtype in [dtypes.int32, dtypes.int64]:
            with ops.Graph().as_default(), self.cached_session(
                ...
                def g_sum(): return math_ops.reduce_sum(array_ops.gather(
