...
inline const char* EnumNameSparseIndexVector(SparseIndexVector e) {
  if (e < SparseIndexVector_NONE || e > SparseIndexVector_Uint8Vector)
    return "";
  const size_t index = static_cast<size_t>(e);
...
inline const char* EnumNameBuiltinOptions(BuiltinOptions e) {
  if (e < BuiltinOptions_NONE || e > BuiltinOptions_SegmentSumOptions)
    return "";
  const size_t index = static_cast<size_t>(e);
...
struct DimensionMetadataT : public flatbuffers::NativeTable {
  ...
  DimensionMetadataT() : format(DimensionType_DENSE), dense_size(0) {}
};
...
struct DimensionMetadata FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  SparseIndexVector array_segments_type() const {
    return static_cast<SparseIndexVector>(
...
template <>
inline const Int32Vector* DimensionMetadata::array_segments_as<Int32Vector>()
    const {
  return array_segments_as_Int32Vector();
}

template <>
inline const Uint16Vector* DimensionMetadata::array_segments_as<Uint16Vector>()
    const {
  return array_segments_as_Uint16Vector();
}

template <>
inline const Uint8Vector* DimensionMetadata::array_segments_as<Uint8Vector>()
    const {
  return array_segments_as_Uint8Vector();
}

template <>
inline const Int32Vector* DimensionMetadata::array_indices_as<Int32Vector>()
    const {
  return array_indices_as_Int32Vector();
}

template <>
inline const Uint16Vector* DimensionMetadata::array_indices_as<Uint16Vector>()
    const {
  return array_indices_as_Uint16Vector();
}

template <>
inline const Uint8Vector* DimensionMetadata::array_indices_as<Uint8Vector>()
    const {
...
struct SparsityParameters FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<DimensionMetadata>>*
  dim_metadata() const {
    return GetPointer<
        const flatbuffers::Vector<flatbuffers::Offset<DimensionMetadata>>*>(
        VT_DIM_METADATA);
...
struct SparsityParametersBuilder {
  ...
  void add_dim_metadata(
      flatbuffers::Offset<
          flatbuffers::Vector<flatbuffers::Offset<DimensionMetadata>>>
          dim_metadata) {
...
inline flatbuffers::Offset<SparsityParameters> CreateSparsityParametersDirect(
    ...
    const std::vector<flatbuffers::Offset<DimensionMetadata>>* dim_metadata =
        nullptr) {
  ...
  auto dim_metadata__ =
      dim_metadata ? _fbb.CreateVector<flatbuffers::Offset<DimensionMetadata>>(
                         *dim_metadata)
                   : 0;
...
template <>
inline const SelectV2Options* Operator::builtin_options_as<SelectV2Options>()
    const {
  return builtin_options_as_SelectV2Options();
}

template <>
inline const DensifyOptions* Operator::builtin_options_as<DensifyOptions>()
    const {
  return builtin_options_as_DensifyOptions();
}

template <>
inline const SegmentSumOptions*
Operator::builtin_options_as<SegmentSumOptions>() const {
  ...
  };
  {
    ...
    if (_e)
      _o->array_segments.value =
          SparseIndexVectorUnion::UnPack(_e, array_segments_type(), _resolver);
  };
  {
  ...
  };
  {
    ...
    if (_e)
      _o->array_indices.value =
          SparseIndexVectorUnion::UnPack(_e, array_indices_type(), _resolver);
  };
}
...
inline void SparsityParameters::UnPackTo(
  ...
  };
  {
    ...
    if (_e) {
      ...
      for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) {
        _o->dim_metadata[_i] =
            std::unique_ptr<DimensionMetadataT>(_e->Get(_i)->UnPack(_resolver));
      }
    }
  };
}
...
inline flatbuffers::Offset<SparsityParameters> CreateSparsityParameters(
  ...
  auto _dim_metadata =
      _o->dim_metadata.size()
          ? _fbb.CreateVector<flatbuffers::Offset<DimensionMetadata>>(
                _o->dim_metadata.size(),
...
inline void Tensor::UnPackTo(
  ...
  };
  {
    ...
    if (_e)
      _o->sparsity =
          std::unique_ptr<SparsityParametersT>(_e->UnPack(_resolver));
  };
  {
...
inline BuiltinOptionsUnion::BuiltinOptionsUnion(const BuiltinOptionsUnion& u)
  ...
  switch (type) {
    ...
    case BuiltinOptions_SelectV2Options: {
      value =
          new SelectV2OptionsT(*reinterpret_cast<SelectV2OptionsT*>(u.value));
      break;
    }
    case BuiltinOptions_DensifyOptions: {
    ...
    case BuiltinOptions_SegmentSumOptions: {
      value = new SegmentSumOptionsT(
          *reinterpret_cast<SegmentSumOptionsT*>(u.value));
      break;
    }
    default:
      break;
