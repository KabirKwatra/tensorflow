...
TEST(SizeUtilTest, Int) {
    SizeUtilTest<int>();
}

TEST(SizeUtilTest, Long) {
    SizeUtilTest<long int>();    // NOLINT
}

TEST(SizeUtilTest, LongLong) {
    SizeUtilTest<long long int>();    // NOLINT
}

TEST(SizeUtilTest, Int32) {
    SizeUtilTest<std::int32_t>();
}

TEST(SizeUtilTest, Int64) {
    SizeUtilTest<std::int64_t>();
}

TEST(SizeUtilTest, Ptrdiff) {
    SizeUtilTest<std::ptrdiff_t>();
}
