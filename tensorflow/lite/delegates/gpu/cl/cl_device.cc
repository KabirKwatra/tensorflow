...
bool MaliInfo::IsBifrostGen3() const {
    return gpu_version == MaliGPU::G76;
}
...
bool CLDevice::SupportsFP16() const {
    return info_.supports_fp16;
}
...
bool CLDevice::SupportsImage3D() const {
    return info_.SupportsImage3D();
}

bool CLDevice::SupportsFP32RTN() const {
    return info_.supports_fp32_rtn;
}

bool CLDevice::SupportsFP16RTN() const {
    return info_.supports_fp16_rtn;
}
...
bool CLDevice::IsAdreno() const {
    return info_.vendor == Vendor::QUALCOMM;
}
...
bool CLDevice::IsPowerVR() const {
    return info_.vendor == Vendor::POWERVR;
}

bool CLDevice::IsNvidia() const {
    return info_.vendor == Vendor::NVIDIA;
}

bool CLDevice::IsMali() const {
    return info_.vendor == Vendor::MALI;
}

bool CLDevice::IsAMD() const {
    return info_.vendor == Vendor::AMD;
}
