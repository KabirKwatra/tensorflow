...
TEST_F(OperatorTest, VersioningAddTest) {
    SimpleVersioningTest<AddOperator>();
}

TEST_F(OperatorTest, VersioningSubTest) {
    SimpleVersioningTest<SubOperator>();
}
...
TEST_F(OperatorTest, VersioningPadTest) {
    SimpleVersioningTest<PadOperator>();
}
