...
XLA_TEST_P(BatchNormTestManySizes, RandomizedTrainingTests) {
    ...
    auto input_squared =
    ReferenceUtil::MapArray4D(input_array, [](float a) {
        return a * a;
    });
...
XLA_TEST_P(BatchNormTestManySizes, RandomizedGradTests) {
    ...
    input_array, mean4D, [](float a, float b) {
        return a - b;
    });
    ...
    scale4D, rsqrt_var_add_epsilon, [](float a, float b) {
        return a * b;
    });

    auto I1 = *ReferenceUtil::MapArray4D(
    grad_output_array, [&](float a) {
        return num_elements_per_feature * a;
    });
    ...
    grad_activation, I5, [](float a, float b) {
        return a - b;
    });

    grad_activation = *ReferenceUtil::MapArray4D(
    grad_activation, scale4D, [](float a, float b) {
        return a * b;
    });
