...
TYPED_TEST(Convolve_1x1x1x2_1x1x1x2_Valid, Types) {
    this->RunTest();
}
...
TYPED_TEST(Convolve_1x1x4x4_1x1x2x2_Valid, Types) {
    this->RunTest();
}
...
TYPED_TEST(Convolve_1x1x4x4_1x1x2x2_Same, Types) {
    this->RunTest();
}
...
TYPED_TEST(Convolve_1x1x4x4_1x1x3x3_Same, Types) {
    this->RunTest();
}
...
TYPED_TEST(Convolve1D_1x2x5_1x2x2_WithRHSDilation, Types) {
    this->RunTest();
}
...
TYPED_TEST(Convolve1D_1x2x5_1x2x2_WithPadding, Types) {
    this->RunTest();
}
...
void iota_int_init_value(std::vector<T>& values, int init_value) {
    ...
    [&](T& value) {
        value = static_cast<T>(init_value++);
    });
}
...
TYPED_TEST(Convolve2D_1x3x3x5_3x3x5x3_Valid, Types) {
    this->RunTest();
}
...
XLA_TEST_P(Convolve1D1WindowTestFloat, Convolve1D1Window) {
    TestImpl<float>();
}
