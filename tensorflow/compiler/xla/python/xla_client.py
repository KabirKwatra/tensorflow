...
class ComputationBuilder(object):
    ...
    def ConvGeneralDilated(
        ...
        return ops.ConvGeneralDilated(
            ...
            lhs_dilation,
            rhs_dilation,
            make_convolution_dimension_numbers(dimension_numbers, len(window_strides)),
            feature_group_count,
            batch_group_count,
            precision_config=precision_config,
        )
    ...
    def Sort(self, operands, dimension=-1, comparator=None, is_stable=False):
        ...
        operands = (
            list(operands)
            if isinstance(operands, collections.abc.Sequence)
            else [operands]
        )
        return ops.Sort(
            self._builder,
    ...
    def TriangularSolve(
        ...
        if not transpose_a:
            ...
            transpose = (
                ...
                if conjugate_a
                else ops.TriangularSolveOptions_Transpose.TRANSPOSE
            )
