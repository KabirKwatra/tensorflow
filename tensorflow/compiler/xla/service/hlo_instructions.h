...
public:
    ...
    absl::optional<int64> split_dimension() const {
        return split_dimension_;
    }
    void set_split_dimension(int64 dim) {
...
public:
    ...
    const std::vector<int64>& dimensions() const override {
        return dimensions_;
    }
    int64 dimensions(int64 index) const override {
...
public:
    ...
    int64 first_index_operand_number() const override {
        return 1;
    }
