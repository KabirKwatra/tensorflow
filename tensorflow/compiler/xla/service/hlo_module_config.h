...
public:
    ...
    void set_launch_id(uint64 launch_id) {
        launch_id_ = launch_id;
    }

    int32 launch_id() const {
        return launch_id_;
    }
    ...
    std::vector<std::vector<int64>>* mutable_dot_config() {
        return &dot_config_;
    }
