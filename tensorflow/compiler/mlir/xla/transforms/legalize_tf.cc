...
static bool IsDefaultDataFormat(StringRef format) {
    return format == "NHWC";
}
...
public:
    ...
    LogicalResult matchAndRewrite(OpTy op,
        ...
        for (RankedTensorType ty : {
                    input_ty, filter_ty, result_ty
                })
