...
public:
    ...
    int64 id() const TF_LOCKS_EXCLUDED(mu_) {
        return id_;
    }
    ...
    string long_name() const {
        return strings::StrCat(name_, "(id:", id_, ")");
    }
    ...
    void record_bytes_consumed(int64 num_bytes) {
        bytes_consumed_ += num_bytes;
    }

    // Records that the node produced the given number of bytes.
    void record_bytes_produced(int64 num_bytes) {
