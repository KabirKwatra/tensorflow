...
public:
    ...
    const JobToken& job_token() {
        return params_.job_token;
    }
...
public:
    ...
    bool fail_if_unimplemented() const {
        return params_.fail_if_unimplemented;
    }

    bool serialize_data_tensors() const {
        return params_.serialize_data_tensors;
    }

    bool preserve_random_seeds() const {
        return params_.preserve_random_seeds;
    }
...
public:
    ...
    virtual int64 AllocatedBytes() const {
        return 0;
    }
    ...
    virtual int64 Cardinality() const {
