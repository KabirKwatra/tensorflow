...
TEST(CommandLineFlagsTest, FailedInt32Hook) {
  ...
  bool parsed_ok = Flags::Parse(
      &argc, argv_array.data(),
      {Flag(
          "some_int32", [](int32 value) { return false; }, 30, "some int32")});
...
TEST(CommandLineFlagsTest, FailedInt64Hook) {
  ...
  bool parsed_ok = Flags::Parse(
      &argc, argv_array.data(),
      {Flag(
          "some_int64", [](int64 value) { return false; }, 30, "some int64")});
...
TEST(CommandLineFlagsTest, FailedFloatHook) {
  ...
  bool parsed_ok =
      Flags::Parse(&argc, argv_array.data(),
                   {Flag(
                       "some_float", [](float value) { return false; }, 30.0f,
                       "some float")});
...
TEST(CommandLineFlagsTest, FailedBoolHook) {
  ...
  bool parsed_ok =
      Flags::Parse(&argc, argv_array.data(),
                   {Flag(
                       "some_switch", [](bool value) { return false; }, false,
                       "some switch")});
...
TEST(CommandLineFlagsTest, FailedStringHook) {
  ...
  bool parsed_ok = Flags::Parse(
      &argc, argv_array.data(),
      {Flag(
          "some_name", [](string value) { return false; }, "", "some name")});
