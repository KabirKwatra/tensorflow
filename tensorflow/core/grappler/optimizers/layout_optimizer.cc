...
protected:
    ...
    virtual Status CustomizedProcessing() {
        return Status::OK();
    }
...
protected:
    ...
    bool IsNodeAfterNCHWToNHWC() const {
        return IsNodeAfterNCHWToNHWC(*node_);
    }
};
...
private:
    ...
    bool IsAlongHW() const {
        return IsAlongAxis({1, 2});
    }
    bool IsAlongNHW() const {
        return IsAlongAxis({0, 1, 2});
    }
};
...
private:
    ...
    bool IsAlongAllFourDims() const {
        return IsAlongAxis({0, 1, 2, 3});
    }

    bool IsAlongHWC() const {
        return IsAlongAxis({1, 2, 3});
    }
    ...
    bool IsAlongC() const {
        return IsAlongAxis({3});
    }

    bool KeepDims() const {
        return node_->attr().at("keep_dims").b();
    }
};
