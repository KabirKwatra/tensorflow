...
const string& Node::type_string() const {
...
DataType Node::input_type(int32 i) const {
...
DataType Node::output_type(int32 o) const {
...
const string& Node::requested_device() const {
    return def().device();
}
