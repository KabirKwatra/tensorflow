...
public:
    ...
    string iterator_prefix() const {
        return iterator_prefix_;
    }
    ...
    virtual std::vector<FunctionDef> func_lib() const {
        return {};
    }
...
public:
    ...
    int64 num_slices() const {
        return components_[0].dim_size(0);
    }

    size_t num_tensors_per_slice() const {
