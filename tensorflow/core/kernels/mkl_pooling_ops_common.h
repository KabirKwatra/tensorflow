...
public:
    ...
    MEMORY_FORMAT GetSrcMemoryFormat() const {
        return context_.src_fmt;
    }
    MEMORY_FORMAT GetDstMemoryFormat() const {
...
public:
    ...
    MEMORY_FORMAT GetDiffDstMemoryFormat() const {
        return context_.diff_dst_fmt;
    }
    MEMORY_FORMAT GetWorkspaceMemoryFormat() const {
