...
int64 ProtoRunStepRequest::request_id() const {
    return request_->request_id();
}
...
int64 InMemoryRunGraphRequest::step_id() const {
    return step_id_;
}

void InMemoryRunGraphRequest::set_step_id(int64 step_id) {
    step_id_ = step_id;
}
...
int64 InMemoryRunGraphRequest::request_id() const {
    return request_id_;
}
...
int64 ProtoRunGraphRequest::step_id() const {
    return request_->step_id();
}
