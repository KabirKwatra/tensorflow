...
public:
    ...
    tensorflow::EagerContext& EagerContext() {
        return ctx_;
    }
    const tensorflow::EagerContext& EagerContext() const {
        return ctx_;
    }
    ...
    const tensorflow::OpDef* OpDef() const {
        return op_def_;
    }
    ...
    absl::InlinedVector<TensorHandle*, 4>* MutableInputs() {
        return &inputs_;
    }
    ...
    const AttrTypeMap* AttrTypes() const {
        return attr_types_;
    }
