...
public:
    ...
    virtual int64 ParamsSizeInBytes() const {
        return -1;
    }
...
public:
    ...
    int64 spatial_dim(DimIndex dim) const {
...
public:
    ...
    // using this filter descriptor.
    int64 bias_count() const {
        return output_feature_map_count();
    }

    int64 output_feature_map_count() const {
        return tensor_.dimensions(0);
    }
...
public:
    ...
    int64 window_height() const {
        return GetDim(window_, DimIndex::Y);
    }
    int64 window_width() const {
        return GetDim(window_, DimIndex::X);
    }
    int64 window(DimIndex dim) const {
        return GetDim(window_, dim);
    }
    int64 vertical_padding() const {
        return GetDim(padding_, DimIndex::Y);
    }
    int64 horizontal_padding() const {
        return GetDim(padding_, DimIndex::X);
    }
    int64 padding(DimIndex dim) const {
        return GetDim(padding_, dim);
    }
    int64 vertical_stride() const {
        return GetDim(strides_, DimIndex::Y);
    }
    int64 horizontal_stride() const {
        return GetDim(strides_, DimIndex::X);
    }
    int64 stride(DimIndex dim) const {
        return GetDim(strides_, dim);
    }
    absl::Span<const int64> window() const {
        return window_;
    }
    absl::Span<const int64> padding() const {
        return padding_;
...
public:
    ...
    absl::optional<AlgorithmDesc> algorithm() const {
        return algorithm_;
    }
    void set_algorithm(AlgorithmDesc val) {
        algorithm_ = val;
    ...
    absl::optional<size_t> scratch_size() const {
        return scratch_size_;
    }
    void set_scratch_size(size_t val) {
        scratch_size_ = val;
